...
def calc_mean_std(df, col):
    #A function that calculates the mean and standard deviation of a specic variable for a dataframe
    avg = np.mean(df[col])
...
def plot_small_large_error(numStdDevs=1):
    ...
    #calculate the mean and standard deviation values for the diameter and the ellipticallity
    ...
    #the x value is the mean diameter forsmall craters
    ...
    #the x value is the mean diameter forlarge craters
